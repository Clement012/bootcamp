...
public class Customer2 {
  ...
  public static void main(String[] args) {
    ...
    ss.remove(0);
    ss.add("abc");
    System.out.println(ss.get(0)); // abc
    ...
    test(new ArrayList<>(List.of("hello","Vincent")));
    test(new HashSet<>(Set.of("world")));

    System.out.println(new ArrayList<>(List.of("Vincent")).contains("Vincent")); //true,performance low
    System.out.println(new HashSet<>(List.of("Vincent")).contains("Vincent")); //true,performance high
  }
