public class StringBox implements CharSequence{
  ...
  public static void main(String[] args) {
    CharSequence ca = new StringBox("hello");
    System.out.println(cs.charAt(1));

    CharSequence ca2 = new StringBox("hello");
    // cs2.replace
    System.out.println(cs2.charAt(1));

    CharSequence ca3 = new StringBox("helllo");
    System.out.println(cs3.charAt(1));
  }
    // all he"l"lo
    System.out.println(ascii, 2);
    System.out.println(ascii2, 2);
    System.out.println(ascii3, 2);
